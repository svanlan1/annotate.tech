              ...
              <ul class="collapsible" data-collapsible="expandable">
                <?php
                  ...
                  while ($row = mysql_fetch_assoc($result)) {
                    echo "<li>";
                    echo "<div class='collapsible-header annotate' style='font-weight:bold;'><i class='material-icons'>filter_drama</i>".$row['username']."</div>";
                    echo "<div class='collapsible-body annotate'><p><span class='table-url'>".$row['url']."</span><span class='table-updated'>".date("m-d-Y",$row['updated'])."</span><span class='table-obj'>".$row['obj']."</span></div>";
                    echo "</li>";
                  }
